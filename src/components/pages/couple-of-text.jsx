...
import { ChevronRight, Database, BookText } from 'lucide-react';
    ...
    <BlockOfCompos>
      <div className="space-y-6">
        ...
        <Breadcrumb>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink href={`/datasets/${idDataset}`} className="text-muted-foreground">
              Dataset {idDataset}
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbItem>
        ...
        <div>
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold tracking-tight">Couple of text</h1>
